...
export type IdentifierType =
  ...
  | "rusko_kaava_slug"
  | "mynamaki_kaava_slug"
  | "kemionsaari_kaava_slug"
  | "marttila_kaava_slug"
  | "pyharanta_kaava_slug"
  | "taivassalo_kaava_slug"
  | "kristiinankaupunki_kaava_slug"
  | "korsnas_kaava_slug"
  | "kruunupyy_kaava_slug"
  | "luoto_kaava_slug"
  | "maalahti_kaava_slug"
  | "pedersore_kaava_slug"
  | "uusikaarlepyy_kaava_slug"
  | "voyri_kaava_slug"
  | "perho_kaava_slug"
  | "lestijarvi_kaava_slug"
  | "ilomantsi_kaava_slug"
  | "tohmajarvi_kaava_slug"
  | "tammela_kaava_slug"
  | "lemi_kaava_slug"
  | "kangasniemi_kaava_slug"
  | "kihnio_kaava_slug"
  | "ristijarvi_kaava_slug"
  | "kolari_kaava_slug"
  | "salla_kaava_slug"
  | "tervola_kaava_slug"
  | "savukoski_kaava_slug"
  | "utsjoki_kaava_slug"
  | "isojoki_kaava_slug"
  | "vimpeli_kaava_slug"
  ...
  | "vierema_kaava_slug"
  | "taipalsaari_kaava_slug"
  | "kinnula_kaava_slug"
  | "nurmes_kaava_slug"
  | "merijarvi_kaava_slug"
  | "haapajarvi_kaava_slug"
  | "haapavesi_kaava_slug"
  | "karsamaki_kaava_slug"
  | "lumijoki_kaava_slug"
  | "muhos_kaava_slug"
  | "pyhajoki_kaava_slug"
  | "pyhajarvi_kaava_slug"
  | "pyhanta_kaava_slug"
  | "pudasjarvi_kaava_slug"
  | "reisjarvi_kaava_slug"
  | "tyrnava_kaava_slug"
  | "asikkala_kaava_slug"
  | "hartola_kaava_slug"
  | "karkola_kaava_slug"
  | "padasjoki_kaava_slug"
  | "sysma_kaava_slug"
  | "koski_tl_kaava_slug"
