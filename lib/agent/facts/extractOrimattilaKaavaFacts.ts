...
export function extractOrimattilaKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Orimattilan kaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "orimattilaKaavaParser",

    decision_index: title ?? "orimattila-kaava",
