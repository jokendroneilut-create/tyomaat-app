...
export function extractSuomussalmiKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Suomussalmen kaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "suomussalmiKaavaParser",

    decision_index: title ?? "suomussalmi-kaava",
