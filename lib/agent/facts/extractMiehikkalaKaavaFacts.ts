...
export function extractMiehikkalaKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Miehikkälän kaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "miehikkalaKaavaParser",

    decision_index: title ?? "miehikkala-kaava",
