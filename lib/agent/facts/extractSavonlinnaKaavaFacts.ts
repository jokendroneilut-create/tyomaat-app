...
export function extractSavonlinnaKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Savonlinnan asemakaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "savonlinnaKaavaParser",

    decision_index: title ?? "savonlinna-kaava",
