...
export function extractSavitaipaleKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Savitaipaleen kaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "savitaipaleKaavaParser",

    decision_index: title ?? "savitaipale-kaava",
