...
export function extractPunkalaidunKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Punkalaitumen kaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "punkalaidunKaavaParser",

    decision_index: title ?? "punkalaidun-kaava",
