...
export function extractHyrynsalmiKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Hyrynsalmen kaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "hyrynsalmiKaavaParser",

    decision_index: title ?? "hyrynsalmi-kaava",
