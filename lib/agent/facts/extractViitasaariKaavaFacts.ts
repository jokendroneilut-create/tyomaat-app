...
export function extractViitasaariKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Viitasaaren kaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "viitasaariKaavaParser",

    decision_index: title ?? "viitasaari-kaava",
