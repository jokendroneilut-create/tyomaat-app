...
export function extractPelkosenniemiKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Pelkosenniemen kaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "pelkosenniemiKaavaParser",

    decision_index: title ?? "pelkosenniemi-kaava",
