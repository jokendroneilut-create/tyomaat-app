...
export function extractPihtipudasKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Pihtiputaan kaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "pihtipudasKaavaParser",

    decision_index: title ?? "pihtipudas-kaava",
