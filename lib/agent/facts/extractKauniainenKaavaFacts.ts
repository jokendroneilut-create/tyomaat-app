...
export function extractKauniainenKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Kauniaisten kaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "kauniainenKaavaParser",

    decision_index: title ?? "kauniainen-kaava",
