...
export function extractLapinlahtiKaavaFacts({
  documentId,
  sourceName,
  title,
  phase,
  ...
  const operation = clean(title) ?? "Lapinlahden kaava"

  const commonMetadata = {
    source_document_id: documentId,
    source_name: sourceName,
    parser: "lapinlahtiKaavaParser",

    decision_index: title ?? "lapinlahti-kaava",
